...
function MarketingTab({ affiliateLink }: MarketingTabProps) {
  ...
  const getShareLinks = (url: string) => ({
    twitter: `https://twitter.com/intent/tweet?text=${encodeURIComponent('Check out BookingPro for your appointment scheduling needs!')}&url=${encodeURIComponent(url)}`,
    linkedin: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}`,
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`,
    whatsapp: `https://wa.me/?text=${encodeURIComponent(`Check out BookingPro: ${url}`)}`,
  });
