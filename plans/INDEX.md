...
| Access & Permissions Redesign | TODO | `docs/superpowers/plans/2026-03-15-access-permissions-redesign.md` | 4-level permissions (no_access/view/reply/manage), bidirectional conversation overrides, conflict resolution UI | None |
