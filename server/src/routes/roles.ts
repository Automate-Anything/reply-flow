...
const DEFAULT_PERMISSIONS: Record<string, { resource: string; action: string }[]> = {
  owner: [
    ...
    { resource: 'conversation_statuses', action: 'view' },
    { resource: 'conversation_statuses', action: 'create' },
    { resource: 'conversation_statuses', action: 'edit' },
    { resource: 'conversation_statuses', action: 'delete' },
    { resource: 'contact_tags', action: 'view' },
    { resource: 'contact_tags', action: 'create' },
    { resource: 'contact_tags', action: 'edit' },
    { resource: 'contact_tags', action: 'delete' },
    { resource: 'custom_fields', action: 'view' },
    { resource: 'custom_fields', action: 'create' },
    { resource: 'custom_fields', action: 'edit' },
    { resource: 'custom_fields', action: 'delete' },
    { resource: 'contact_lists', action: 'view' },
    { resource: 'contact_lists', action: 'create' },
    { resource: 'contact_lists', action: 'edit' },
    { resource: 'contact_lists', action: 'delete' },
