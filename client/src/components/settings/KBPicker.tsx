...
import { FileText, BookOpen, Plus, X, Check, Search, MessageSquare, ChevronDown } from 'lucide-react';
                ...
                {isExpanded ? (
                  <div className="border-t px-3 py-2">
                    <textarea
                      ...
                      disabled={disabled}
                      className="w-full resize-none rounded-md border bg-background px-3 py-2 text-xs placeholder:text-muted-foreground/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50"
                    />
                  </div>
                ) : (
                  <button
                    ...
                    disabled={disabled}
                    className="flex w-full items-center gap-1.5 border-t px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer disabled:opacity-50"
                  >
